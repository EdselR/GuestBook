...
private constructor() {
    ...
    (context: Context?, private val mDetector: Detector<*>?) {
        private val mCameraSource = CameraSources()
...
//            }
    ...
    @Throws(IOException::class)
    fun start(surfaceHolder: SurfaceHolder): CameraSources {
        synchronized(mCameraLock) {
            if (mCamera != null) {
                return this
            }
...
//        }
    ...
    companion object {
        ...
        /**
         * The dummy surface texture must be assigned a chosen borrower_name.  Since we never use an OpenGL
